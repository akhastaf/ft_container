...
namespace   ft
{
    ...
    class RedBlackTree
    {
        ...
        public:
            ...
            reverse_iterator rbegin()  { return reverse_iterator(iterator(getMaximum(), _endNode)); }
            ...
            // {
            //     iterator tmp = iterator(upper_bound(_root, k), _endNode);
            ...
            //         {
            //             if (!getSuccessor(tmp))
            //                 return getParentPredecessor(tmp);
            //             return getSuccessor(tmp);
            //         }
